...
class AppConstants {
  ...
  // Market
  static String get defaultMarketId => dotenv.env['DEFAULT_MARKET_ID'] ?? 'huyen_demo';
  
  // Vietmap
  static String get vietmapTilemapKey => dotenv.env['VIETMAP_TILEMAP_KEY'] ?? '';
  static String get vietmapServicesKey => dotenv.env['VIETMAP_SERVICES_KEY'] ?? '';
